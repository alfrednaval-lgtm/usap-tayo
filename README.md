...
Tagalog speaking and writing practice for kids, with Talusi the Palawan hornbill.

**Open it:** https://alfrednaval-lgtm.github.io/usap-tayo/

- On the PC: open the link in Chrome or Edge, then use the "Install" icon in the address bar.
- On Android: open the link in Chrome, then menu > "Add to Home screen".
